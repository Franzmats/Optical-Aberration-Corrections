...
NN = 6#side length of the SLM in pixels; the number of correctable modes is thus N x N
N = 6#number of scattered modes = N^2
...
#figure(3)
#M=M/(2*pi)
#imshow(M[:,:,0], cmap='hsv', origin='lower')
#colorbar(label='2π units')
# Show the plot
