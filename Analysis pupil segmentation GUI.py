from functions import average_phase, fit_phase, generate_filenamePrefix, phase_unwrap_regular,pupil_segmentation_init, read_pupil_segmentation,retrieve_phase,save_figures,save_phase_slm, slm_interpolation, unwrap_all_pupils
...
while run_file:
    ...
    out = retrieve_phase(data, param, out) #calls phase_unwrap_regular
